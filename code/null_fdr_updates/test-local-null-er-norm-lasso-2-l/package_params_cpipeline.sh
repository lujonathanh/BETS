...
#export GENES=test-new-null-prot2TPM-0mean1var-reps       #protein-coding
#export LOADREPS=1
...
# Causal params
export CAUSAL=lasso       # Name of causal folder
export HYPERFILE="$CAUSAL/hyperlist_$CAUSAL.p"
export TEST=l                  # THIS SHOULD CORRESPOND TO CAUSAL
export LAG=2

# Null, FDR params
export NULL=l               # l for local, g for global
export STRATIFY=n      # Set to "e" to stratify by effect when doing FDR. Else to "n" to not stratify at all. See README for description.
